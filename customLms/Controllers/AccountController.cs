...
namespace customLms.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Subscriptions(string studentId)
        {
            ...
            var ids = model.studentSubscriptions.Select(us => us.id);
        ...
        public async Task<ActionResult> Subscriptions(StudentSubscriptionViewModel model)
        {
            try
            {
            ...
            return RedirectToAction("Subscriptions", "Account", new { studentId = model.studentId });
       ...
       // [HttpPost]
        ...
        public async Task<ActionResult> Edit(string studentId)
        {
            if (studentId == null ||  studentId.Equals(string.Empty ))
            {
                return new HttpStatusCodeResult(HttpStatusCode.BadRequest);
            }
            ApplicationUser user = await UserManager.FindByIdAsync(studentId);
            if (user == null)
            {
                return HttpNotFound();
            }
